    ...
    <section>
      <div className="flex justify-center items-center gap-6">
        ...
        {stock - quantityInCart > contador ? (
          ...
          <button className=" display-none text-3xl text-slate-200 mb-2  border-solid border-2 border-slate-400 rounded-lg">
            <IoAdd />
          </button>
        )}
      </div>
      {stock - quantityInCart >= contador ? (
        <button
          ...
          className="cursor-pointer text-3xl text-slate-400 mb-2 hover:text-slate-100  rounded-lg"
        >
          <FaCartPlus />
        </button>
      ) : (
