    ...
    <header>
      <nav className="flex justify-between items-center">
        <div className="flex gap-4 px-4 py-4">
          <Link to="/">
            <img
              src="https://i.pinimg.com/564x/3b/23/66/3b2366b0b6508869c4084867f7e591e5.jpg"
              alt="logo"
          ...
          <div className="hidden md:flex px-6">
            <ul className="flex gap-4 list-none mt-4">
              ...
              <Link to="/category/Watch">
                <li className="cursor-pointer hover:text-white">SmartWatch</li>
              </Link>
              ...
              <Link to="/category/Computers">
                <li className="cursor-pointer hover:text-white">MacBook</li>
              </Link>
            </ul>
          </div>
        </div>
          ...
          <div className="absolute top-14 left-60 right-0 bottom-0 bg-black bg-opacity-50 flex justify-center items-start z-10 py-4">
            <div className="bg-white p-4 rounded-lg">
              ...
              <ul className="list-none text-black py-4">
                <Link to="/">
                  <li className="cursor-pointer hover:text-slate-400 py-2">
                    Home
                  </li>
                </Link>
                <Link to="/category/Watch">
